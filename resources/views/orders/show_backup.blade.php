        ...
        <div class="col-md-12 total-items">
            <div class="box box-info">
                ...
                <div class="box-body">
                    <div class="form-group">
                        @if ($first_payment)
                            <input type="hidden" name="first_payment_id" id="first_payment_id" value="{{ $first_payment->id }}">
                        @endif
                        ...
                        <select class="form-control" id="payment_method_first" name="payment_method_first">
                            @foreach ($payment_methods as $payment_method)
                                <option value="{{ $payment_method->id }}"
                                    @if ($first_payment && $payment_method->id == $first_payment->payment_method_id)
                                        selected
                                    @endif>
                                    {{ $payment_method->name }}
                                </option>
                        ...
                        <select class="form-control" id="payment_merchant_first" name="payment_merchant_first" required>
                            @foreach ($payment_merchants as $payment_merchant)
                                <option value="{{ $payment_merchant->id }}"
                                    {{ $payment_merchant->id == optional($first_payment)->payment_merchant_id ? 'selected' : '' }}>
...
@section('layout_js')
    ...
    <script>
        ...
        $(function() {
            ...
            $('#biaya, #biaya_edit, #discount, #discount_item, #discount_item_edit, #kekurangan-sisa').on('input',
                function(e) {
