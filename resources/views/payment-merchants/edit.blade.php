...
@section('content')
    ...
    <div class="box box-warning">
        <div class="box-header with-border">
            <h3 class="box-title">Edit Penyedia Pembayaran</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group {{ $errors->has('payment_method_id') ? 'has-error' : '' }}">
                            ...
                            <select name="payment_method_id" id="payment_method_id" class="form-control" data-placeholder="Pilih Metode Pembayaran" required>
                    ...
                    <div class="col-lg-12">
                        <a href="{{ route('payment-merchants.show', $payment_merchant->id) }}" class="btn btn-default pull-left" style="margin-right: 15px;">Kembali ke Detail Payment</a>
                        <button type="submit" class="btn btn-warning pull-right"><i class="fa fa-fw fa-save"></i> Update</button>
                        <a href="{{ route('payment-merchants.index') }}" class="btn btn-default pull-right" style="margin-right: 15px;"><i class="fa fa-fw fa-close"></i> Kembali ke Halaman Penyedia Pembayaran</a>
                    </div>
                </div>
            </form>
        </div>
