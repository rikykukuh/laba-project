        ...
        <div class="table-responsive">
            <table class="table table-sm table-striped table-bordered" cellpadding="0">
                ...
                <tr>
                    ...
                    <th class="text-right" style="font-size: 14px;width: 15%;">Discount</th>
                ...
                @foreach($order->orderItems as $orderItem)
                    <tr>
                        ...
                        <td class="text-right" style="font-size: 14px;">Rp{{ number_format($orderItem->discount, null, ",", ".") }}</td>
                        <td class="text-right" style="font-size: 14px;">Rp{{ number_format($orderItem->netto, null, ",", ".") }}</td>
                    </tr>
                @endforeach
                </tbody>
            </table>
                ...
                <div class="table-responsive">
                    <table class="table table-total">
                        <tr>
                            ...
                            <td class="" style="font-size: 14px;" >Rp{{ number_format($order->orderItems->sum('netto'), null, ",", ".") }}</td>
                        </tr>
                        <!-- <tr>
