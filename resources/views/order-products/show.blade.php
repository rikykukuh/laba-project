...
{{--                                    @dd($orderItem->bruto * $orderItem->quantity * ($orderItem->discount / 100))--}}
    ...
    @if((strpos($userAgent, 'Android') !== false || strpos($userAgent, 'iPad') !== false))
        ...
        <div class="col-md-12 total-items">
            ...
            <button type="button" class="btn bg-purple" id="btn-pickup" data-toggle="modal" data-target="#modal-pickup-item" style="margin-bottom: 15px;">
            ...
            <!-- Save Button -->
            <button type="button" class="btn bg-olive" id="btn-simpan" style="margin-bottom: 15px; margin-right: 10px;" onclick="pickUpItemForm(event)">
            ...
            <div class="btn-group" role="group" aria-label="Print Options" style="margin-bottom: 15px;">
                <a href="{{ route('order-products.print', $order->id) }}?type=customer" target="_blank" class="btn bg-navy" style="margin-right: 5px;">
                    <i class="fa fa-fw fa-print"></i>
                    <span>Customer</span>
                </a>
                <a href="{{ route('order-products.print', $order->id) }}?type=cashier" target="_blank" class="btn bg-navy" style="margin-right: 5px;">
                    <i class="fa fa-fw fa-print"></i>
                    <span>Cashier</span>
                </a>
