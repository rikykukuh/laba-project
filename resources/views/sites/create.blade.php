...
@section('title', 'Add Sites')

@section('menu_pagina')

	<li role="presentation">
		<a href="{{ route('sites.index') }}" class="link_menu_page">
			<i class="fa fa-list-ol"></i> Sites
		</a>
	</li>
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Form Add Site</h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                               <button type="submit" class="btn btn-primary pull-right"><i class="fa fa-fw fa-plus"></i> Add</button>
                                <a href="{{ route('sites.index') }}" class="btn btn-default pull-right" style="margin-right: 15px;"><i class="fa fa-fw fa-close"></i> Cancel</a>
                            </div>
                        </div>
                    </form>
				</div>
