        ...
        <div class="box-body">
            <form action="{{ route('clients.update', $client->id) }}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <a href="{{ route('clients.show', $client->id) }}" class="btn btn-default pull-left" style="margin-right: 15px;">Back to Detail Client</a>
                        <button type="submit" class="btn btn-warning pull-right"><i class="fa fa-fw fa-save"></i> Update</button>
                        <a href="{{ route('clients.index') }}" class="btn btn-default pull-right" style="margin-right: 15px;"><i class="fa fa-fw fa-close"></i> Back to Clients</a>
                    </div>
                </div>
            </form>
        </div>
