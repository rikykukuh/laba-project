...
class OrderController extends Controller
{
    ...
    public function show($id)
    {
        ...
        ->orderBy('id', 'asc')
        ->first();
        $second_payment = Payment::where('order_id', $id)
        ->orderBy('id', 'desc')
        ->first();
        $payment_methods = PaymentMethod::all();
        $payment_merchants = PaymentMerchant::all();
        ...
        return view('orders.show', compact('order', 'customers', 'statuses', 'payment_methods', 'payment_merchants', 'products', 'sites', 'config', 'first_payment', 'second_payment'));
    }
