...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/order-logs', [LogController::class, 'showOrderLogs'])->name('order.logs');
     Route::get('/orders/selesai-besok', 'App\Http\Controllers\Order\OrderController@selesaiBesok')->name('orders.selesai-besok');
...
Route::group(['prefix'=>'laporan'], function(){
    ...
    Route::get('/reparasi', '\App\Http\Controllers\Order\OrderController@report')->name('laporan.reparasi');
...
Route::middleware('auth')->group(function () {
    ...
    Route::resource('stock-move', \App\Http\Controllers\StockMove\StockMoveController::class);
    Route::resource('warehouse', \App\Http\Controllers\Warehouse\Warehouse::class);
